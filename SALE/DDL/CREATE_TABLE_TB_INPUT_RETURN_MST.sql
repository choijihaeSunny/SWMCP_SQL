-- swmcp.tb_input_return_mst definition

CREATE TABLE `tb_input_return_mst` (
  `COMP_ID` varchar(10) NOT NULL COMMENT '사업장코드',
  `SET_DATE` varchar(8) NOT NULL COMMENT '등록일자',
  `SET_SEQ` varchar(4) NOT NULL COMMENT '등록순번',
  `INPUT_RETURN_MST_KEY` varchar(30) NOT NULL COMMENT '입고반품MST번호',
  `RETURN_DATE` varchar(8) DEFAULT NULL COMMENT '반품일자',
  ...
  PRIMARY KEY (`COMP_ID`,`INPUT_RETURN_MST_KEY`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='구매반품MST';