-- swmcp.tb_matr_etc_out_det definition

CREATE TABLE `tb_matr_etc_out_det` (
  ...
  `MATR_ETC_OUT_KEY` varchar(30) NOT NULL COMMENT '기타출고KEY',
  ...
  PRIMARY KEY (`COMP_ID`,`MATR_ETC_OUT_KEY`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='자재기타출고DET';