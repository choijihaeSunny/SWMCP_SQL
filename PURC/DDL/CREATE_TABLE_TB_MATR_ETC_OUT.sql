-- swmcp.tb_matr_etc_out definition

CREATE TABLE `tb_matr_etc_out` (
  `COMP_ID` varchar(10) NOT NULL COMMENT '사업장코드',
  `SET_DATE` varchar(8) NOT NULL COMMENT '등록일자',
  `SET_SEQ` varchar(4) NOT NULL COMMENT '등록순번',
  `MATR_ETC_OUT_MST_KEY` varchar(30) NOT NULL COMMENT '기타출고MST번호',
  `OUT_DATE` varchar(8) DEFAULT NULL COMMENT '출고일자',
  ...
  PRIMARY KEY (`COMP_ID`,`MATR_ETC_OUT_MST_KEY`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='자재기타출고MST';