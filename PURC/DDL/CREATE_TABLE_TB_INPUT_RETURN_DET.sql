-- swmcp.tb_input_return_det definition

CREATE TABLE `tb_input_return_det` (
  ...
  `INPUT_RETURN_KEY` varchar(30) NOT NULL COMMENT '입고반품KEY',
  ...
  `RETURN_CAUSE` bigint(20) DEFAULT NULL COMMENT '반품사유',
  `END_AMT` decimal(16,4) DEFAULT 0.0000 COMMENT '마감금액',
  `CALL_KIND` varchar(10) DEFAULT NULL COMMENT '호출구분(구매입고내역)',
  ...
  PRIMARY KEY (`COMP_ID`,`INPUT_RETURN_KEY`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='입고만품DET';