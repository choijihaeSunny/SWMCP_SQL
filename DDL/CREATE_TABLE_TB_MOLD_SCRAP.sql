-- swmcp.tb_mold_scrap definition

CREATE TABLE `tb_mold_scrap` (
  ...
  `MOLD_SCRAP_KEY` varchar(30) NOT NULL COMMENT '금형폐기번호',
  ...
  `SCRAP_CAUSE` bigint(20) DEFAULT NULL COMMENT '폐기사유',
  ...
  PRIMARY KEY (`COMP_ID`,`MOLD_SCRAP_KEY`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='금형폐기관리';