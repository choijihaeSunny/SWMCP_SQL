...
begin
	...
	if A_KIND = '%' then
		SELECT BILL_NO,
	           ...
	           BILL_AMT,
-- 	           BAL_CUST_NM,
	           (select cust_name from tc_cust_code  where cust_code = TBL_BILLS_RECEIVABLE.BAL_CUST_CD) as BAL_CUST_NM,
	           BAL_BANK,
...
--                  	and code =  BAL_BANK) as BAL_BANK_NM,
               (select cust_name from tc_cust_code  where cust_code = TBL_BILLS_RECEIVABLE.BAL_BANK) as BAL_BANK_NM,
...
--                  	and code =  DISC_BANK) as DISC_BANK_NM,
               (select cust_name from tc_cust_code  where cust_code = TBL_BILLS_RECEIVABLE.DISC_BANK) as DISC_BANK_NM,
...
--                  	and code =  TRUST_BANK) as TRUST_BANK_NM,
	           (select cust_name from tc_cust_code  where cust_code = TBL_BILLS_RECEIVABLE.TRUST_BANK) as TRUST_BANK_NM,
	           AC_NO,
	           CUST_CODE,
...
-- 				  WHERE PATH = 'cfg.acnt.CC02'
--                  	and code =  TRUST_BANK) as TRUST_BANK_NM,
	           (select cust_name from tc_cust_code  where cust_code = TBL_BILLS_RECEIVABLE.BAL_BANK) as TRUST_BANK_NM,
	           AC_NO,
	           CUST_CODE,
